...
public:
    ...
    /**
     * @brief 平滑移动到指定角度
     * @param target_x_angle 目标水平角度
     * @param target_y_angle 目标垂直角度
     * @param servo_delay 舵机移动延迟
     */
    void SmoothMoveTo(int target_x_angle, int target_y_angle, int servo_delay = SERVO_DELAY);
    
    /**
     * @brief 设置舵机移动速度
     * @param speed 移动速度（1-10，数值越大越快）
     */
